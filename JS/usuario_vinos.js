...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("btnBlanco").addEventListener("click", function() {
        filtrarProductos("Blanco, Rueda y Verdejo")
    })

    document.getElementById("btnTinto").addEventListener("click", function() {
        filtrarProductos("Tinto Ribera del Duero")
    })

    document.getElementById("btnCrianza").addEventListener("click", function() {
        filtrarProductos("Crianza Ribera del Duero")
    })

    document.getElementById("btnOtrasOpciones").addEventListener("click", function() {
        filtrarProductos("Otras opciones")
    })
})
